// 将一组页面的路由将给一个widget来负责，而不是放在主路由栈中
import 'package:flutter/material.dart';

// 路由路径在flutter中会自动关联吗?
const routeHome = '/';
const routeSettings = '/settings';
// The setup flow pages, however, use two paths to create their route names: a /setup/ prefix followed by the name of the specific page. 
// By combining the two paths, your Navigator can determine that a route name is intended for the setup flow without recognizing all the individual pages associated with the setup flow.
