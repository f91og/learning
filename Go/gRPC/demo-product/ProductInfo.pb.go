...
type Product struct {
	...
	Id          string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`     // 定义一个string类型的字段，字段名字为id, 序号为1。后面的数字是字段的序列号，不是字段的值
	Name        string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"` // proto文件中，字段后面的序号，不能重复，定义了就不能修改，可以理解成字段的唯一ID。
